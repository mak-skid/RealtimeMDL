...
In this study, we assumed that the historical data length of 60 seconds and the target data length of 10 seconds is most likely optimal and exhibit most coleration of features between them from the shockwave pattern shown in Fig. 3.1. % DOUBLE CHECK THE FIGURE NUMBER ONE LAST TIME
