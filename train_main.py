"""
Entry point for datapreprocessing and training the model
...
param_set = [
    {"timewindow": 10, "num_section_splits": 9, "history_len": 6, "with_ramp": True, "num_skip": 1},
    {"timewindow": 10, "num_section_splits": 9, "history_len": 6, "with_ramp": True, "num_skip": 2},
    {"timewindow": 10, "num_section_splits": 9, "history_len": 6, "with_ramp": False, "num_skip": 1},
    {"timewindow": 10, "num_section_splits": 9, "history_len": 6, "with_ramp": False, "num_skip": 2},
    {"timewindow": 0.5, "num_section_splits": 9, "history_len": 120, "with_ramp": True, "num_skip": 20},
    {"timewindow": 0.5, "num_section_splits": 9, "history_len": 120, "with_ramp": False, "num_skip": 20},
]

for experiment in param_set:
    timewindow = experiment["timewindow"]
    num_section_splits = experiment["num_section_splits"]
    history_len = experiment["history_len"]
    with_ramp = experiment["with_ramp"]
    num_skip = experiment["num_skip"]
    ...
    createMDLModelAndTrain(train_dataset=train_dataset, num_features=1, num_skip=num_skip, realtime_mode=realtime_mode)