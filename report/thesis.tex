...
\begin{figure}[ht!]
    ...
    \caption{The structure of the orginal MDL model. From Lu et al.}
\end{figure}
...
The pipeline consists of three main components: the data ingestion component, the Kafka streaming component, and the Spark Structured Streaming component. We first explain these underlying technologies used in this framework.
...
\begin{table}[ht!]
    ...
    \begin{tabular}{ |P{3cm}|P{2.5cm}|P{2cm}|P{2cm}|P{2cm}|P{1.5cm}| }
        ...
        \hline
        \multirow{4}{*}{Original MDL} & \multirow{4}{*}{speed, density} & \multirow{4}{*}{2} & 0.5 sec & Yes & 10 sec\\
         & & & 0.5 sec & No & 10 sec\\
         & & & 10 sec & Yes & 10 sec\\
         & & & 10 sec & No & 10 sec\\
        \hline
        \multirow{4}{*}{Downsized MDL} & \multirow{4}{*}{speed} & \multirow{4}{*}{1} & 0.5 sec & Yes & 10 sec\\
         & & & 0.5 sec & No & 10 sec\\
         & & & 10 sec & Yes & 10 sec\\
         & & & 10 sec & No & 10 sec\\ 
        \hline
